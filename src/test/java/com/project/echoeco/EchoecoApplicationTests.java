...
class EchoecoApplicationTests {
	...
	// String[]
	// cityList={"서울","경기","인천","강원","충북","충남","대전","전북","전남","경북","경남","제주"};
	//
	// String[][] stateList = {
	...
	// { "대전시", "서산시", "논산시", "계룡시", "공주시", "금산군", "논산시", "당진시", "보령시", "부여군",
	// "서천군", "아산시", "예산군", "천안시", "홍성군"},
	// { "대전시"},
	// { "전주시", "군산시", "익산시", "정읍시", "남원시", "김제시", "완주군", "진안군", "무주군", "장수군",
	// "임실군", "순창군", "고창군", "부안군"},
	// { "목포시", "여수시", "순천시", "나주시", "광양시", "담양군", "곡성군", "구례군", "무안군", "보성군",
	// "신안군", "여수시", "영광군", "영암군", "완도군", "장성군", "장흥군", "진도군", "함평군", "해남군", "화순군"},
	// { "대구시", "포항시", "경주시", "안동시", "구미시", "영주시", "영천시", "상주시", "문경시", "경산시",
	// "김천시", "칠곡군", "고령군", "성주군", "영덕군", "청도군", "청송군", "예천군"},
	// { "부산시", "창원시", "진주시", "양산시", "거제시", "통영시", "김해시", "밀양시", "사천시", "김해시",
	// "밀양시", "사천시", "거창군", "고성군", "남해군", "산청군", "양산시", "의령군", "함안군", "함양군", "합천군"},
	// { "제주시", "서귀포시"}};
	...
	void insertActivity() {
		...
		// for(int i = 0; i<100; i++) {
		// Activity activity =
		// Activity.builder().createdAt(LocalDateTime.now()).contents("내용1").title("제목
		// "+i).createdBy("ltk2956").goalCnt(5).curruntCnt(0).state(state.get()).build();
		...
		// Activity modifyAt = at.toBuilder().contents("수정된
