...
// import com.project.echoeco.member.auth.AuthController;
...
// @InjectMocks
// private AuthController memberController;
// @MockBean
...
// .content(objectmapper.writeValueAsBytes(new MemberJoinRequest(email,
// password, name))))
...
// .with(SecurityMockMvcRequestPostProcessors.csrf())
// .contentType(MediaType.APPLICATION_JSON)
// .content(objectmapper.writeValueAsBytes(new MemberLoginRequest(email,
// password))))
// .andDo(MockMvcResultHandlers.print())
